...
//first operation
$queryOne = "SELECT * FROM students WHERE Grade='10'";
$resultOne = mysqli_query($con, $queryOne);
$countOne=mysqli_num_rows($resultOne);
//second operation
$queryTwo = "SELECT SUM(fTerm+sTerm+tTerm) AS total_marks FROM marks WHERE fTerm>=75 and sTerm>=75 and tTerm>=75 and Grade='10'";
...
//third operation
$queryThree = "SELECT COUNT(sports) AS total_sport FROM students WHERE Grade='10' AND sports IS NOT NULL ";
$resultThree = mysqli_query($con, $queryThree);
$countThree=mysqli_num_rows($resultThree);
//fourth operation
$queryFour = "SELECT COUNT(society) AS total_society FROM students WHERE Grade='10' AND society IS NOT NULL ";
